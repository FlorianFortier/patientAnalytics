 ...
 * <p>
 * This class defines the security settings for the application, including JWT authentication,
...
public class SecurityConfig {
     ...
     * <p>
     * This method disables CSRF, enforces authentication for all requests, sets the session
     * policy to stateless, and integrates the {@link JwtAuthenticationFilter} before the
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/diabetes/risk").authenticated()
